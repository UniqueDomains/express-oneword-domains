# Available .EXPRESS One-Word Domains (23,890)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-23%2C890%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **23,890 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 23,890 domains · **Median ask:** $14.18 · **High-demand under $2,500:** 0
...
| door.express | resell    | —         | —             | medium         | low    | 4      | Squarespace Domains II LLC                                |
...
| mark.express | resell    | —         | —             | medium         | medium | 4      | Global Domains International, Inc. DBA DomainCostClub.com |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 23,890 live domains                        |
...
> Unique Domains. *Available .EXPRESS One-Word Domains*. Version 2026-09-16. Public GitHub extract for the exact Unique Domains search represented by this repository.
